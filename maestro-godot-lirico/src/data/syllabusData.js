    ...
    gemas: [
      {
        ...
        pregunta: {
          ...
          enunciado: "Estás creando un juego para un concurso de 'retro-gaming' que debe funcionar en ordenadores muy antiguos. ¿Qué renderizador sería la elección más sabia y segura?",
      ...
      },
      {
        ...
        pregunta: {
          tipo: "seleccion_multiple",
          enunciado: "Si estás diseñando un puzzle donde diferentes objetos deben caer y encajar correctamente según su peso y forma, ¿qué componente fundamental del motor de juego estás utilizando principalmente?",
          opciones: [
          ...
          respuestaCorrecta: "El sistema de Física para simular el peso y las colisiones."
        }
      },
      {
        id: 103,
        ...
        pregunta: {
          tipo: "seleccion_multiple",
          enunciado: "Has seleccionado un nodo de personaje en la dársena de 'Escena'. ¿En qué parte de la interfaz modificarías su velocidad de movimiento o su color?",
          opciones: ["La Dársena del Inspector", "El Viewport", "El Sistema de Archivos", "La Consola de Salida"],
      ...
      },
      {
        ...
        pregunta: {
          ...
          enunciado: "En el espacio 2D, el eje Y generalmente representa la profundidad para saber si un objeto está delante o detrás de otro.",
      ...
      },
      {
        ...
        pregunta: {
          tipo: "verdadero_falso",
          enunciado: "Para cambiar el sprite de todos los 50 enemigos idénticos que tienes en tu nivel, debes editar cada una de las 50 instancias de enemigo individualmente.",
          opciones: ["Verdadero", "Falso"],
          respuestaCorrecta: "Falso"
        }
      },
      {
        ...
        pregunta: {
          tipo: "seleccion_multiple",
          enunciado: "Tienes un nodo 'Personaje' con un nodo 'Escudo' como hijo. Si mueves el 'Personaje' 10 píxeles a la derecha, ¿qué debes hacer para que el 'Escudo' también se mueva?",
          opciones: ["Nada, el escudo se moverá automáticamente con su padre.", "Escribir un script para mover el escudo 10 píxeles.", "Mover manualmente el escudo 10 píxeles en el editor.", "Hacer que el 'Personaje' sea hijo del 'Escudo'"],
          respuestaCorrecta: "Nada, el escudo se moverá automáticamente con su padre."
        }
      },
      {
        id: 107,
        ...
        pregunta: {
          tipo: "seleccion_multiple",
          enunciado: "Para usar una imagen que tienes en tu escritorio como el sprite de tu personaje en Godot, ¿a qué panel del editor deberías arrastrarla primero?",
          opciones: ["La Dársena del Sistema de Archivos", "El Inspector", "La Dársena de Escena", "El Viewport"],
      ...
      },
      {
        ...
        pregunta: {
          tipo: "seleccion_multiple",
          enunciado: "Después de construir tu menú principal en una escena llamada 'MenuPrincipal.tscn', ¿dónde irías para asegurarte de que el juego siempre comience en esa escena?",
          opciones: ["En el Inspector del nodo raíz del menú.", "En los Ajustes del Proyecto, en la sección 'Application/Run'.", "En el Gestor de Proyectos, antes de abrir el editor.", "En un script adjunto a la cámara."],
          respuestaCorrecta: "En los Ajustes del Proyecto, en la sección 'Application/Run'."
        }
      }
    ],
    jefeFinal: {
      ...
      descripcion: "Demuestra tu maestría construyendo una escena simple pero completa a partir de varios nodos y assets importados para desbloquear el siguiente Reino."
    }
  },
  {
    reinoId: 2,
    ...
    gemas: [
      ...
      { id: 202, nombre: "Variables y Tipos de Datos: La Esencia de la Información" },
      { id: 203, nombre: "Colecciones: Forjando Listas (Arrays) y Diccionarios" },
      ...
      { id: 209, nombre: "La Biblioteca del Saber: Usando la Documentación de Godot" }
    ],
    jefeFinal: {
      id: 299,
      nombre: "Jefe Final: El Escriba Interactivo",
      descripcion: "Crea un script que haga que un personaje reaccione a la entrada del jugador y se comunique con otro nodo a través de señales."
    }
  },
  {
    reinoId: 3,
    ...
    jefeFinal: {
      ...
      descripcion: "Construye un pequeño nivel de plataformas donde el jugador pueda correr, saltar y colisionar con el entorno."
    }
  },
  {
    reinoId: 4,
    ...
    gemas: [
      ...
      { id: 404, nombre: "Partículas: Magia Visual para Efectos Deslumbrantes" },
      { id: 405, nombre: "Shaders: Pintando con Código para Efectos Únicos" }
    ],
    jefeFinal: {
      id: 499,
      nombre: "Jefe Final: El Artista Total",
      descripcion: "Crea una escena de juego con una interfaz de usuario funcional (vida, puntuación), un personaje animado y un efecto visual usando partículas o un shader simple."
    }
  },
  {
    reinoId: 5,
    ...
    gemas: [
      ...
      { id: 502, nombre: "Autoloads (Singletons): Nodos Globales para Gestionar tu Juego" },
      { id: 503, nombre: "Guardado y Carga de Partidas: Persistencia de Mundos" },
    ...
    jefeFinal: {
      ...
      descripcion: "Finaliza un mini-juego completo, con música, efectos de sonido, un menú principal, la capacidad de guardar la puntuación y exportarlo como un ejecutable."
    }
  }
];